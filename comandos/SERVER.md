...
postgres=# create role reginaldojunior with login superuser createdb createrole password '#Jr615387';
CREATE ROLE
postgres=# create database projeto_agenda with owner reginaldojunior;
CREATE DATABASE
postgres=# grant all privileges on database projeto_agenda to reginaldojunior;
GRANT

'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'projeto_agenda',
        'USER': 'reginaldojunior',
        'PASSWORD': '#Jr615387',
        'HOST': 'localhost',
        'PORT': '5432',
